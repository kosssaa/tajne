...
public class SklepKomputerowy {
    public static void main(String[] args) {
        wypiszWszystkieKomputery();
    }

    private static void wypiszWszystkieKomputery() {
    }
    ...
    List<Komputer> list5 = new ArrayList<>(Arrays.asList(
            komputer1,
            komputer2,
            komputer3,
            komputer4,
    ...
    public static void wypiszWszystkieKomputery(List<Komputer> list){
